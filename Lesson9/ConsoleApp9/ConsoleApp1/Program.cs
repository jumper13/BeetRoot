...
Console.WriteLine("Hello, Team!");	// 2. Show all meeting
Console.WriteLine("First line");	// 1. Add meeting - without validation
Console.WriteLine("Second line");	// 0. Exit calendar
